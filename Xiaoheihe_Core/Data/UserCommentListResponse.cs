...
{
    public sealed class UserCommentListResponse : BasicResponse<HashSet<UserCommentListResultData>>
    {
    ...
    public sealed class UserCommentListResultData : BasicResultData
    {
    ...
    public class BaseCommentLinkData
    {
